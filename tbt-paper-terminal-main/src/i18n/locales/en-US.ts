...
export const enUS: Locale = {
  ...
  wallet: {
    ...
    depositPending: 'Awaiting Approval',
    depositConfirmed: 'Deposit Confirmed',
    depositFailed: 'Deposit Failed',
    depositApprovalHint: 'Real deposits stay pending until approved by an admin or boss.',
    depositRealOnlyHint: 'Switch to the real account to submit a deposit request.',
    depositSubmitFailed: 'Unable to create the deposit request.',
